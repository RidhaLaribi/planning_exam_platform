        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                ...
                <button
                    ...
                    className="px-6 py-3 bg-primary hover:bg-primary-hover text-white font-medium rounded-xl shadow-md transition-all flex items-center"
                >
                                ...
                                <tr key={idx} className="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${schedule.status === 'validated_doyen' ? 'bg-green-100 text-green-800' :
                                            schedule.status === 'validated_chef' ? 'bg-primary/10 text-primary' :
